...
Dog.create(name: "Shane", breed: "Cocker Spaniel", age: 7)
Dog.create(name: "Dexter", breed: "Bischon", age: 8)
Dog.create(name: "Bo", breed: "Golden Retriever", age: 2)
Dog.create(name: "Percy", breed: "Golden Retriever", age: 4)
Dog.create(name: "Ruby", breed: "Mutt", age: 12)
...
Employee.create(first_name: "Toby", last_name: "Flenderson", alias: "The worst", title: "HR Representative", office: "Scranton", dog: Dog.third, img_url: "https://pbs.twimg.com/media/DAM0C36VwAA19DM.jpg:large")
